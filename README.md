...
- настройки IP/port/MAC сохраняются через Flet `SharedPreferences`;
- SSDP обнаружение LG webOS TV через multicast-запрос;
- выбор найденного телевизора из списка в разделе "Ещё";
- запоминание последнего подключенного телевизора;
...
Настройки IP/port/MAC сохраняются через Flet `SharedPreferences` в разделе **Ещё**.

Приложение автоматически находит LG webOS TV в сети через SSDP. Нажмите "Найти телевизоры" в разделе "Ещё" для обнаружения устройств.
